...
public final class DruidWallConfigUtil {
    ...
    public static WallConfig toWallConfig(DruidWallConfig c, DruidWallConfig g) {
        ...
        Boolean tempConditionOpBitwiseAllow = c.getConditionOpBitwiseAllow() == null ? g.getConditionOpBitwiseAllow() : c.getConditionOpBitwiseAllow();
        if (tempConditionOpBitwiseAllow != null && !tempConditionOpBitwiseAllow) {
