package com.citics.glxtapi.plugin.db;

import com.citics.glxtapi.plugin.db.domain.AbstractRoutingDataSource;
import com.citics.glxtapi.plugin.db.domain.GroupDataSource;
import com.citics.glxtapi.plugin.db.domain.ItemDataSource;
import com.citics.glxtapi.plugin.db.provider.DynamicDataSourceProvider;
import com.citics.glxtapi.plugin.db.strategy.DynamicDataSourceStrategy;
import com.citics.glxtapi.plugin.db.strategy.LoadBalanceDynamicDataSourceStrategy;
...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource implements InitializingBean, DisposableBean {
    ...
    public DataSource determineDataSource() {
        ...
        // log.info("当前使用的数据源是:[{}]", StringUtils.isNotEmpty(dataSourceType) ? dataSourceType : "默认数据源");
