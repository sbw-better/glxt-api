...
import com.citics.glxtapi.web.model.Attributes;
...
public abstract class AbstractTable extends Attributes<Object> {
    ...
    public AbstractTable column(String property) {
        if (StringUtils.isNotBlank(property)) {
            this.fields.add(rowMapColumnMapper.apply(property));
        }
        return this;
    }
    ...
    public AbstractTable groupBy(String... properties) {
        this.groups.addAll(Arrays.stream(properties)
                .map(rowMapColumnMapper)
